 ...
 * @date 2013-2-2 Copyright Huawei Technologies Co., Ltd. 1998-2011. All rights
 *       reserved.
 */
...
public class MPDateWheelDialog extends MPDialog
{
	 ...
	 */
	public MPDateWheelDialog(Context context, OnDateSetListener callBack, int year,
	 ...
	 *            The initial day of the dialog.
	 */
	public MPDateWheelDialog(Context context, int theme, OnDateSetListener callBack, int year,
			int monthOfYear, int dayOfMonth)
	{
		super(context, theme);
		mContext = context;
