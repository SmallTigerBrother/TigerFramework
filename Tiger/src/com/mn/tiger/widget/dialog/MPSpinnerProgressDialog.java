...
public class MPSpinnerProgressDialog extends MPDialog implements IProgressDialog
{
	...
	public MPSpinnerProgressDialog(Context context, int theme)
	{
		super(context, theme);
		setupDialog();
	}

	public MPSpinnerProgressDialog(Context context, boolean cancelable, OnCancelListener cancelListener)
	{
