...
{	
	...
	public MPPullToRefreshDataController(Context context, MPPullToRefreshListView<T> listView)
	{
	...
	private void updateListView()
	{
		if(null != listItems)
		{
			MPListAdapter<T> listAdapter = (MPListAdapter<T>) ((HeaderViewListAdapter)
	...
	public void setPullToRefreshListView(
			MPPullToRefreshListView<T> pullToRefreshListView) 
	{
