 ...
 * @date 2014年2月10日
 */
public class TGPullToRefreshController implements IPullToRefreshController 
{
	/**
	 * 日志标签
	 */
	 ...
	 * 拖动刷新列表
	 */
	private TGPullToRefreshListView<?> listView;
	...
	public TGPullToRefreshController(Context context, TGPullToRefreshListView<?> listView) 
	{
	 ...
	 * @param listView
	 */
	public void setPullToRefreshListView(TGPullToRefreshListView<?> listView) 
	{
		this.listView = listView;
	}
	 ...
	 * @return
	 */
	public TGPullToRefreshListView<?> getPullToRefreshListView() 
	{
		return listView;
	}
