...
import com.mn.tiger.widget.pulltorefresh.library.adapter.MPPullToRefreshListAdapter;
import com.mn.tiger.widget.pulltorefresh.pullinterface.IPullToRefreshDataController;
import com.mn.tiger.widget.pulltorefresh.pullinterface.MPPullToRefreshController;
import com.mn.tiger.widget.pulltorefresh.pullinterface.MPPullToRefreshDataController;
...
public class MPPullToRefreshListView<T> extends AutoPullToRefreshListView
{
	 ...
	 * 列表适配器
	 */
	private MPPullToRefreshListAdapter<T> adapter = null;
	...
	public MPPullToRefreshListView(Context context, AttributeSet attrs)
	{
		super(context, attrs);

		setPullToRefreshController(new MPPullToRefreshController(context, this));
		this.pullToRefreshDataController = new MPPullToRefreshDataController<T>(context, this);
	}
	...
	protected Handler handler = new Handler()
	{
		...
		public void handleMessage(Message msg)
		{
			...
			//停止列表刷新，拖出视图消失
			MPPullToRefreshListView.this.onRefreshComplete();
		}
	 ...
	 * @param adapter
	 */
	public void setAdapter(MPPullToRefreshListAdapter<T> adapter)
	{
