...
{
	private static final String TAG = DropDownListView.class.getSimpleName();
	 ...
	 * @date 2014年4月17日
	 */
	public DropDownListView(Context context, int width, int height, int animationStyle)
	{
		super(context);
	 ...
	 * @date 2014年4月17日
	 */
	public DropDownListView(Context context, int width, int height)
	{
