...
public class MPTabView extends LinearLayout
{
	...
	public MPTabView(Context context)
	{
		...
		tabItems = new ArrayList<MPTabView.TabItem>();
	}

	public MPTabView(Context context, AttributeSet attrs)
	{
		super(context, attrs);
	...
	{
		void onTabChanged(MPTabView tabView, int lastTabIndex, int currentTabIndex);
	}
