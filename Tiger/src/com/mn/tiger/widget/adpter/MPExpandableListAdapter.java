 ...
 */
public abstract class MPExpandableListAdapter<GParam,CParam> extends android.widget.BaseExpandableListAdapter 
{
	/**
	 * 日志标签
	 */
	 ...
	 */
	public MPExpandableListAdapter(Context context, List<GParam> groups, List<List<CParam>> childs)
	{
