 ...
 * </p>
 */
public class TGDirectionalViewPager extends ViewPager
{
	...
	public TGDirectionalViewPager(Context context)
	{
		super(context);
		initViewPager();
	}

	public TGDirectionalViewPager(Context context, AttributeSet attrs)
	{
		super(context, attrs);
		initViewPager();
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec)
	{
		...
		mChildWidthMeasureSpec = MeasureSpec.makeMeasureSpec(getMeasuredWidth() - getPaddingLeft()
		...
		switch (action & MotionEventCompat.ACTION_MASK)
		{
			...
			case MotionEvent.ACTION_UP:
				if (mIsBeingDragged)
				{
					...
					if (mOrientation == HORIZONTAL)
					{
						initialVelocity = (int) VelocityTrackerCompat.getXVelocity(velocityTracker,
								mActivePointerId);
					...
					{
						initialVelocity = (int) VelocityTrackerCompat.getYVelocity(velocityTracker,
								mActivePointerId);
