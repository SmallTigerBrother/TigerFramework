...
public class ColumnUtils {
    ...
    public static Class<?> getForeignEntityType(com.mn.tiger.datastorage.db.table.Foreign foreignColumn) {
    ...
    public static Class<?> getFinderTargetEntityType(com.mn.tiger.datastorage.db.table.Finder finderColumn) {
