...
public class FinderLazyLoader<T>
{
	...
	public List<T> getAllFromDb() throws DbException
	{
		...
		{
			entities = finderColumn.db.findAll(Selector.from(finderColumn.getTargetEntityType())
	...
	public T getFirstFromDb() throws DbException
	{
		...
		if (finderColumn != null && finderColumn.db != null)
		{
			entity = (T) finderColumn.db.findFirst(Selector
					.from(finderColumn.getTargetEntityType()).where(
