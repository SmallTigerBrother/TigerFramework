...
public class SwipeListViewTouchListener implements View.OnTouchListener
{
	...
	public void setSwipeFrontView(int swipeFrontView)
	{
		this.swipeFrontView = swipeFrontView;
	}

	public void setSwipeBackView(int swipeBackView)
	{
		this.swipeBackView = swipeBackView;
	}
	...
	{
		final View child = swipeListView.getChildAt(position - swipeListView.getFirstVisiblePosition()).findViewById(
				swipeFrontView);
