...
public class SwipeListView extends ListView
{
	...
	public void setFrontAndBackView(int swipeFrontViewId, int swipeBackViewId)
	{
		this.swipeFrontView = swipeFrontViewId;
		this.swipeBackView = swipeBackViewId;
		
		getSwipeListViewTouchListener().setSwipeFrontView(swipeFrontViewId);
		getSwipeListViewTouchListener().setSwipeBackView(swipeBackViewId);
	}
	...
	private SwipeListViewTouchListener getSwipeListViewTouchListener()
	{
		...
		{
			touchListener = new SwipeListViewTouchListener(this, 0, 0);
