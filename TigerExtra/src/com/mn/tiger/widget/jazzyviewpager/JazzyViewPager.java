...
public class JazzyViewPager extends ViewPager
{
	...
	{
		return mEnabled ? super.onInterceptTouchEvent(motionEvent) : false;
	}
	...
	{
		Log.v(TAG,title + ": ROT (" + v.getRotation() + ", " + v.getRotationX() + ", "
						+ v.getRotationY() + "), TRANS (" + v.getTranslationX() + ", "
						+ v.getTranslationY() + "), SCALE (" + v.getScaleX() + ", " + v.getScaleY()
						+ "), ALPHA " + v.getAlpha());
	}
	...
	public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels)
	{
		...
		mLeft = ((JazzyPagerAdapter)getAdapter()).findViewFromObject(position);
		mRight = ((JazzyPagerAdapter)getAdapter()).findViewFromObject(position + 1);
	...
	public void setAdapter(JazzyPagerAdapter viewPager)
	{
		viewPager.bindViewPager(this);
		super.setAdapter(viewPager);
	}
}