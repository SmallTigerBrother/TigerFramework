...
import com.mn.tiger.widget.swipelistview.SwipeListViewTouchListener;
...
public class PullToRefreshSwipeListView extends PullToRefreshAdapterViewBase<SwipeListView>
{
	...
	{
		super(context);
		setOnScrollListener(getRefreshableView().getSwipeListViewTouchListener().makeScrollListener());
	}
