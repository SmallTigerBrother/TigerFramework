...
public class HorizontalViewPagerActivity extends TGActionBarActivity implements OnPageChangeListener
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(R.layout.horizontal_viewpager_activity);
